<div class="col-lg-12">
    ...
    <div class="row form-group">
                                                ...
                                                <div class="col col-md-4">
                                                    <input type="date" id="text-input" name="tgl_lahir" placeholder="Nama Lengkap" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                ...
                                                <div class="col col-md-3">
                                                    <input type="email" id="email-input" name="email" placeholder="Email Pengguna" class="form-control">
                                            ...
                                            <div class="row form-group">
                                                <div class="col col-md-3">
                                                    <label for="select" class=" form-control-label">Level Akses</label>
                                                </div>
                                                <div class="col col-md-3">
                                                <?php
    ...
    <div class="row form-group">
                                                ...
                                                <div class="col col-md-3">
                                                    <input type="text" id="text-input" name="kuota" placeholder="Kuota" class="form-control">
