...
<body class="animsition">
    <div class="page-wrapper">
                    ...
                    <ul class="navbar-mobile__list list-unstyled">
                        <li class="has-sub">
                            ...
                            <ul class="navbar-mobile-sub__list list-unstyled js-sub-list">
                                <li>
                                    <a href="<?php echo base_url();?>template/index.html">Dashboard 1</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>template/index2.html">Dashboard 2</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>template/index3.html">Dashboard 3</a>
                                </li>
                                <li>
                                    <a href="<?php echo base_url();?>template/index4.html">Dashboard 4</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                        ...
                        <li>
                            <a href="table.html">
                                <i class="fas fa-table"></i>tableeeeeeeeeeeeeeee</a>
                        </li>
                        <li>
                            <a href="form.html">
        ...
        <aside class="menu-sidebar d-none d-lg-block">
            <div class="logo">
                <a href="#">
                    <img src="<?php echo base_url();?>template/images/icon/logo.png" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar__content js-scrollbar1">
                <nav class="navbar-sidebar">
                    <ul class="list-unstyled navbar__list">
                        ...
                        <li>
                            <a class="js-arrow" href="#">
                                <i class="fas fa-chart-bar"></i>User Agent</a>
                            <ul class="list-unstyled navbar__sub-list js-sub-list">
                                <li>
                                    <a href="index.html">Daftar User</a>
                                </li>
                                <li>
                                    <a href="index2.html">Lihat Pendaftaran</a>
                                </li>
                            </ul>
                        </li>
                        <li>
                            <a href="chart.html">
                                <i class="far fa-check-square"></i>Konfirmasi Pendaftaran</a>
                        </li>
                            ...
                            <div class="header-button">
                                        ...
                                        <div class="mess-dropdown js-dropdown">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url();?>template/images/icon/avatar-06.jpg" alt="Michelle Moreno" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="mess__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url();?>template/images/icon/avatar-04.jpg" alt="Diane Myers" />
                                                </div>
                                                <div class="content">
                                                    <h6>Diane Myers</h6>
                                    ...
                                    <div class="noti__item js-item-menu">
                                        ...
                                        <div class="email-dropdown js-dropdown">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url();?>template/images/icon/avatar-06.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url();?>template/images/icon/avatar-05.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                            ...
                                            <div class="email__item">
                                                <div class="image img-cir img-40">
                                                    <img src="<?php echo base_url();?>template/images/icon/avatar-04.jpg" alt="Cynthia Harvey" />
                                                </div>
                                                <div class="content">
                                                    <p>Meeting about new dashboard...</p>
                                ...
                                <div class="account-wrap">
                                    <div class="account-item clearfix js-item-menu">
                                        <div class="image">
                                            <img src="<?php echo base_url();?>template/images/icon/avatar-01.jpg" alt="John Doe" />
                                        </div>
                                        <div class="content">
